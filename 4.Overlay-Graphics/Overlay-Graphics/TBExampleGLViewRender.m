 ...
 * commands.
 */
@interface TBExampleGLContext : NSObject {
...
@implementation TBExampleGLContext
...
+ (TBExampleGLContext *)sharedContext
{
    static dispatch_once_t pred;
    static TBExampleGLContext *sharedContext = nil;
...
+ (void) useContext
{
    EAGLContext *context = [[TBExampleGLContext sharedContext] context];
...
@implementation TBExampleGLViewRender {
...
- (void)setFrame:(CGRect)frame {
    ...
    if (frameBufferHandle && colorBufferHandle && _lock) {
        ...
        @synchronized(_lock) {
            ...
            dispatch_sync([TBExampleGLContext sharedContext].contextQueue, ^{
                
                EAGLContext* oglContext = [TBExampleGLContext sharedContext].context;
                
                [TBExampleGLContext useContext];
                 ...
                 textureVertices:(const GLfloat*)textureVertices
{
	...
	// Present
	glBindRenderbuffer(GL_RENDERBUFFER, colorBufferHandle);
	[[TBExampleGLContext sharedContext].context presentRenderbuffer:GL_RENDERBUFFER];
}
